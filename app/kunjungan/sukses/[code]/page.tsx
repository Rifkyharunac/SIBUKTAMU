    ...
    return (
      <PublicShell kiosk={kiosk}>
        <section className="visit-finish-page mx-auto grid min-h-[78vh] max-w-2xl place-items-center px-4 py-12 sm:px-6">
          <div className="visit-success-card w-full overflow-hidden rounded-[2rem] border border-sky-200 bg-white shadow-[0_30px_80px_rgba(7,89,133,0.18)]">
            <div className="bg-[#0369a1] px-6 py-9 text-center text-white">
              <CheckCircle2 className="mx-auto size-16" />
              <h1 className="mt-4 text-3xl font-black">Kunjungan selesai</h1>
              <p className="mt-2 text-sky-100">Jam keluar sudah tercatat pada dashboard petugas.</p>
            </div>
  ...
  return (
    <PublicShell kiosk={kiosk}>
      <section className="visit-finish-page mx-auto grid min-h-[82vh] max-w-3xl place-items-center px-4 py-10 sm:px-6 sm:py-12">
        <div className="print-area visit-success-card w-full overflow-hidden rounded-[2rem] border border-sky-200 bg-white shadow-[0_30px_80px_rgba(7,89,133,0.18)]">
          <div className="relative overflow-hidden bg-[#0369a1] px-6 py-8 text-center text-white sm:py-10">
            ...
            <p className="relative mx-auto mt-2 max-w-lg text-sm leading-6 text-sky-100 sm:text-base">Tetap gunakan halaman ini. Setelah urusan selesai, cukup tekan tombol “Selesaikan kunjungan” di bagian bawah.</p>
          </div>

          <div className="p-5 sm:p-8">
            <div className="visit-code-panel rounded-2xl border-2 border-dashed border-sky-300 bg-sky-50 p-5 text-center">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#0369a1]">Kode kunjungan aktif</p>
              <p className="mt-2 break-all text-3xl font-black tracking-tight text-sky-950 sm:text-4xl">{code}</p>
              <Button type="button" variant="outline" size="sm" className="mt-4 border-sky-300 bg-white" onClick={() => copyValue(code, "code")}>
            ...
            <div className="mt-6 grid gap-4 rounded-2xl bg-slate-50 p-4 text-sm sm:grid-cols-2 sm:p-5">
              <div className="flex items-start gap-3"><Clock3 className="mt-0.5 size-5 shrink-0 text-[#0369a1]" /><div><p className="font-bold text-slate-900">Jam masuk</p><p className="mt-0.5 text-slate-600">{search.get("time") || "Tercatat otomatis"} WITA</p></div></div>
              <div className="flex items-start gap-3"><MapPin className="mt-0.5 size-5 shrink-0 text-[#0369a1]" /><div><p className="font-bold text-slate-900">Tujuan layanan</p><p className="mt-0.5 text-slate-600">{search.get("department") || "Bidang tujuan"}</p><p className="mt-0.5 text-xs text-slate-500">{search.get("service")}</p></div></div>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <Button type="button" className="h-12 flex-1 rounded-xl bg-[#0369a1] text-base font-bold shadow-lg shadow-sky-900/15 hover:bg-[#075985]" disabled={checkingOut} onClick={finishVisit}>
