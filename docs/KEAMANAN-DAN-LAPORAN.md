...
- Token acak 256-bit untuk tautan pribadi kunjungan, hanya hash disimpan di DB. Token dibawa dalam fragmen URL. Tautan pribadi lama tetap berfungsi. Menu publik Selesaikan layanan kini menampilkan nama, antrean, dan waktu kedatangan untuk kunjungan belum selesai; penyelesaian berdasarkan pilihan nama tidak memverifikasi identitas tamu. Siapa pun yang dapat membuka halaman dapat memilih nama; dialog konfirmasi mencegah kekeliruan, bukan penyalahgunaan identitas. Terapkan pendampingan petugas jika diperlukan. Nomor HP, keperluan, tanda tangan, dan token pribadi tidak tampil. Penyelesaian dan log status disimpan secara atomik; permintaan ulang tidak mengubah jam keluar. Receipt survei hanya berlaku untuk penilaian kunjungan yang baru diselesaikan.
